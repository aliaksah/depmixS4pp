...
<p align="justify">
In this package we are adding adaptive simulated variable selection, and various prediction options for the standard [depmixS4](https://cran.r-project.org/web/packages/depmixS4/index.html) for inference on-homogeneous hidden Markov models (NHHMM)
