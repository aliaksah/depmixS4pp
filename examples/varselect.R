...
data.example2$maexpr<-data.example2$Ma*data.example2$express_noisy
data.example2$mgexpr<-data.example2$Mg*data.example2$express_noisy
data.example2$mdexpr<-data.example2$Md*data.example2$express_noisy
data.example2$ppos = data.example2$pos 

fparam = colnames(data.example2)[c(8:10,12:17,21,23,26,29,30,31,32,33)]
...
ids = sample.int(30,30,F)
png(file=paste("modsEPI.png",sep = ""),width     = 10,
    height    = 5,
    units     = "in",
    res       = 500)
